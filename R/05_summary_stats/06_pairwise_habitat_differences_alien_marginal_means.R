# Purpose: Pairwise comparisons among grassland types in marginal means 
# of alien species proportions (Table S5, Fig.S11, Fig.S12).
...
alien_data <- read_csv("data/alien_dataset_all.csv") %>% 
