...
results <- results |>
  filter(response_var %in% c("non_native_percent", "archaeophyte_percent",  "neophyte_percent", "invasive_percent"))
...
results <- results |>
  ...
  mutate(
    response_var = factor(response_var,
      levels =
        c(
          "non_native_percent", "archaeophyte_percent", "neophyte_percent", "invasive_percent" 
        )
    ),
