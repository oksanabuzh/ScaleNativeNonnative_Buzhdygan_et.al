...
inv_m1a<- glmer(invasive_percent ~  
                  pca1_clima + pH + microrelief + heat_index + 
                  cover_litter + cover_herbs_sum + cover_gravel_stones + builtup_1000m + 
                  cropland_1000m + grazing_intencity + mowing + abandonment +
                  (1 | dataset), weights = total_species, family = binomial, 
...
inv_m1b<- glmer(invasive_percent ~  
                  pca1_clima + pH + microrelief + heat_index + 
                  cover_litter + cover_herbs_sum + cover_gravel_stones + builtup_500m + 
                  cropland_500m + grazing_intencity + mowing + abandonment +
                  (1 | dataset), weights = total_species, family = binomial, 
...
inv_m1c<- glmer(invasive_percent ~  
                  pca1_clima + pH + microrelief + heat_index + 
                  cover_litter + cover_herbs_sum + cover_gravel_stones + builtup_250m + 
                  cropland_250m + grazing_intencity + mowing + abandonment +
                  (1 | dataset), weights = total_species, family = binomial, 
...
inv_mod2<- glmer(invasive_percent ~  roads + Disturbance.Frequency + 
                   Disturbance.Severity + (1 | dataset), weights = total_species, 
                 family = binomial, 
                 data = alien_data_100, 
                 control = lme4::glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 50000)))
...
#------------------------------------------------------------------------------#
## Mod 3 ----
inv_mod3 <- glmer(invasive_percent ~  pca1_clima + native + (1 | dataset), weights = total_species, 
                  family = binomial, 
                  data = alien_data_100, 
                  control = lme4::glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 50000)))
...
invasive_SpatAutocor <- autocor_inv_mod1a %>% 
  bind_rows(autocor_inv_mod1b, autocor_inv_mod1c, autocor_inv_mod2, autocor_inv_mod3) %>% 
...
neoph_m1a<- glmer(neophyte_percent ~  
                    pca1_clima + pH + microrelief + heat_index + 
                    cover_litter + cover_herbs_sum + cover_gravel_stones + builtup_1000m + 
                    cropland_1000m + grazing_intencity + mowing + abandonment +
                    (1 | dataset), weights = total_species, family = binomial, 
...
neoph_m1b<- glmer(neophyte_percent ~  
                    pca1_clima + pH + microrelief + heat_index + 
                    cover_litter + cover_herbs_sum + cover_gravel_stones + builtup_500m + 
                    cropland_500m + grazing_intencity + mowing + abandonment +
                    (1 | dataset), weights = total_species, family = binomial, 
...
neoph_m1c<- glmer(neophyte_percent ~  
                    pca1_clima + pH + microrelief + heat_index + 
                    cover_litter + cover_herbs_sum + cover_gravel_stones + builtup_250m + 
                    cropland_250m + grazing_intencity + mowing + abandonment +
                    (1 | dataset), weights = total_species, family = binomial, 
...
neoph_mod2<- glmer(neophyte_percent ~  roads + Disturbance.Frequency + 
                     Disturbance.Severity + (1 | dataset), weights = total_species, 
                   family = binomial, 
                   data = alien_data_100, 
                   control = lme4::glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 50000)))
...
#------------------------------------------------------------------------------#
## Mod 3 ----
neoph_mod3 <- glmer(neophyte_percent ~  pca1_clima + native + (1 | dataset), weights = total_species, 
                    family = binomial, 
                    data = alien_data_100, 
                    control = lme4::glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 50000)))
...
neophyte_SpatAutocor <- autocor_neoph_mod1a %>% 
  bind_rows(autocor_neoph_mod1b, autocor_neoph_mod1c, autocor_neoph_mod2, autocor_neoph_mod3) %>% 
